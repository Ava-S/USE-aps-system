...
public class APS {
    ...
    Product[] makeDatabase(){
        Product[] database = new Product[20];
        ...
        database[4] = new Product("4084500636293L", "Dreft Clean & soft afwasmiddel aloe-komkommer", 2.29);
        ...
        database[17] = new Product("8711000351116","Douwe Egbert Espresso Oploskoffie", 3.99);
    ...
    Product getProductByEan(String ean) throws IllegalArgumentException{
        System.out.println(ean);
        System.out.println(products);
        for (Product p: products){
            String productEan = p.ean; 
